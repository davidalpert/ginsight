...
func (c *Client) UpdateObjectTypePosition(objectTypeID string, newPosition int) (InsightObjectType, error) {
...
func (c *Client) UpdateObjectTypePositionAndParent(objectTypeID string, newPosition int, newParentTypeID int) (InsightObjectType, error) {
	body := map[string]interface{}{
		"position":       newPosition,
