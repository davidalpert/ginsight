...
var Cmd = &cobra.Command{
	Use:   "update",
	Short: "Update schema or objects in Insight",
	Long: `
Provides subcommands to update various schema elements or objects in a Jira Insight installation.

`,
	Example: `
# List all object schemas
insight update type Datacenter --schema IT --description "a new description"`,
...
func init() {
	...
	// Subcommands
	Cmd.AddCommand(CmdUpdateType)
	//Cmd.AddCommand(CmdUpdateTypeAttribute)
}
